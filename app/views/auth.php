                ...
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <form method="POST" action="../controllers/authController.php">
                      ...
                      <input name="correo" type="email" id="form2Example17" placeholder="Ingresa tu correo" class="form-control form-control-lg border-start-0 border-top-0 border-end-0"  />
                        
                      </div>

                      <div class="form-outline mb-4">
                        <input name="clave" type="password" id="form2Example27"placeholder="Ingresa tu contraseña" class="form-control form-control-lg border-start-0 border-top-0 border-end-0" />
